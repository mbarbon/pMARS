 ...
 * $Id: str_eng.c,v 1.20 1996/02/20 19:15:50 stst Exp stst $
 */
...
"portable MARS v%d.%d.%d, %s, corewar simulator with ICWS'94 extensions\n";
char   *credits_screen2 =
"(c) 1993-95 by Albert Ma, Na'ndor Sieben, Stefan Strack and Mintardjo Wangsaw\n";
